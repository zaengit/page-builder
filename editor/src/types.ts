...
export type BlockDefinition = {
  ...
  supports?: { children?: boolean; allowedChildren?: string[] };
};

export type PageBlock = { id: string; type: string; version?: number; attrs: Record<string, unknown>; children?: PageBlock[] };
