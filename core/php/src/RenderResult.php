...
final readonly class RenderResult
{
    ...
    public function __construct(public string $html, public array $assets = ['css' => [], 'js' => []], public array $diagnostics = []) {}
    ...
    {
        return ['html' => $this->html, 'assets' => $this->assets, 'diagnostics' => $this->diagnostics];
    }
}
